rootProject.name = "genesisproduct-howto-send-email-with-attachment"
...
// Add your document management and notify dependencies here:
genesis {
    dependencies {
...
include("howto-send-email-with-attachment-app")
