systemDefinition {
    global {
        ...
        item(name = "DbHost", value = "jdbc:h2:file:~/genesis-local-db/howto-send-email-with-attachment/h2/test;DB_CLOSE_DELAY=-1;NON_KEYWORDS=VALUE,KEY;AUTO_SERVER=TRUE")
        item(name = "DbQuotedIdentifiers", value = true)
        item(name = "DEPLOYED_PRODUCT", value = "howto-send-email-with-attachment")
    ...
    systems {
        ...
        system(name = "DEV") {
            ...
            item(name = "DbNamespace", value = "HOWTO_SEND_EMAIL_WITH_ATTACHMENT")
