notify {
    gateways {
        ...
        // you can find more on this in the following documentation (https://learn.genesis.global/docs/components/notifications/notifications-server/email/#using-system-definition-in-the-notifykts-script).
        email("Email") {
            smtpHost =  "localhost"
            smtpPort = 587
            smtpUser = "*"
